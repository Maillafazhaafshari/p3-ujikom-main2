        ...
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Data Order
                    <a href="{{ url('customers-create') }}" class="btn btn-danger">+ Pelanggan Baru</a>
                </h4>
            </div>
            <div class="card-body">
                ...
                @if ($cek_customer != 0)
                    <form action="{{ route('pelayanan.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="orm-group has-success">
                                        ...
                                        <select id="id" name="harga_id"
                                            class="form-control select2 @error('harga_id') is-invalid @enderror">
                                            <option value="">-- Jenis Pakaian --</option>
                                            @foreach ($jenisPakaian as $jenis)
                                                <option value="{{ $jenis->id }}"
                                                    {{ old('harga_id') == $jenis->id ? 'selected' : '' }}>
                                                    {{ $jenis->jenis }}</option>
                                            @endforeach
                                        </select>
                                        @error('harga_id')
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="number" name="disc" placeholder="Masukkan Diskon"
                        ...
                        <div class="form-actions">
                            ...
                            <button type="reset" class="btn btn-outline-warning mr-1 mb-1">Hapus</button>
                        </div>
                    </form>
                @else
